...
import { parseRequestHeaders, resolveRequestBodyPath } from './requestHeaderParser';
...
export class HttpRequestParser implements RequestParser {
  ...
  public constructor(private requestRawText: string, private settings: WorkspaceConfiguration) {}
